...
export declare class IndexedDbPersistence implements Persistence {
    ...
    constructor(allowTabSynchronization: boolean, persistenceKey: string, clientId: ClientId, platform: Platform, lruParams: LruParams, queue: AsyncQueue, serializer: JsonProtoSerializer, sequenceNumberSyncer: SequenceNumberSyncer);
    /**
